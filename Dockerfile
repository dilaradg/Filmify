...
# Aufruf:   docker build --tag juergenzimmermann/film:2025.10.1-trixie .
#               ggf. --progress=plain
#               ggf. --no-cache
...
#           docker save juergenzimmermann/film:2025.10.1-trixie > film.tar
#           docker network ls
...
LABEL org.opencontainers.image.title="film" \
  org.opencontainers.image.description="Appserver film mit Basis-Image Debian Trixie" \
